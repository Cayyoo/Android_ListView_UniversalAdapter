...
import com.imooc.baseadapter.myadapter.MyAdapter;
import com.imooc.baseadapter.myadapter.MyCommonAdapter;
...
public class MainActivity extends Activity {
    ...
    private void mySetAdapter() {
        mListView.setAdapter(new BaseLvAdapter<Bean>(MainActivity.this, mDatas, R.layout.item) {
            private List<Integer> mPos = new ArrayList<Integer>();

            @Override
            public void convert(final BaseLvHolder holder, final Bean bean) {
